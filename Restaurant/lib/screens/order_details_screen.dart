...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void initState() {
    ...
    if (widget.order.pickupOtp == null || widget.order.pickupOtp!.isEmpty) {
      widget.order.pickupOtp = '4892';
    }
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _buildInfoRow('Pickup Slot', widget.order.pickupSlot ?? '7:30 PM - 7:45 PM'),
          const SizedBox(height: 8),
          _buildInfoRow('Pickup Verification OTP', widget.order.pickupOtp ?? '4892'),
      ...
      child: SafeArea(
        child: Row(
          children: [
            ...
            const SizedBox(width: 12),
            ElevatedButton(
              onPressed: _currentStatus == 'Handed Over' || _currentStatus == 'Delivered' ? null : _advanceOrderState,
              style: ElevatedButton.styleFrom(
                backgroundColor: widget.order.isSelfPickup && _customerArrived ? Colors.orange : AppColors.primaryGreen,
                elevation: 0,
