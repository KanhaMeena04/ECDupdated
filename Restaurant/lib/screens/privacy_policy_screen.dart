        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('ECDKART Restaurant App ("App") is operated by ECDKART (OPC) PRIVATE LIMITED.', style: GoogleFonts.poppins(fontSize: 15, color: Colors.grey[700], height: 1.5)),
              const SizedBox(height: 24),
              ...
              _buildSection('2. Use of Information', 'Information is used to:\n\n• Manage restaurant accounts and orders.\n• Process payments and settlements.\n• Provide delivery/order-related services.\n• Verify restaurant/business information.\n• Improve security, performance and customer support.'),
