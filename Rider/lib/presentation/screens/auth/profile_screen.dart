...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _submitWithdrawalRequest(double balance) async {
    ...
    if (amount < 200) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Minimum withdrawal amount is â‚¹200')),
      );
      return;
    }
  ...
  void _showPolicyDialog(BuildContext context, String title) {
    ...
    if (title == 'Privacy Policy') {
      intro = 'Effective Date: 13 August 2026\n\nECDKART Rider App (â€œAppâ€) is operated by ECDKART (OPC) PRIVATE LIMITED.';
      items = [
        ...
        {'title': '2. Use of Information', 'desc': 'Your information may be used to:\nâ€¢ Verify and manage your rider account.\nâ€¢ Assign and track deliveries.\nâ€¢ Process earnings and payments.\nâ€¢ Provide customer and restaurant support.\nâ€¢ Maintain safety, security and prevent fraud.'},
      ...
      items = [
        ...
        {'title': 'Minimum Withdrawal', 'desc': 'A minimum of â‚¹200 is required for a payout request.'},
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text('â‚¹${_codBalance.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.bold)),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                Text('- â‚¹${_codEarnings.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.green)),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'â‚¹${_amountToPayAdmin.toStringAsFixed(0)}',
