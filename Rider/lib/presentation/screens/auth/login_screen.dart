...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _checkForSavedCredentials() async {
    ...
    print("ðŸ” LOGIN SCREEN - Checking saved data:");
    print("   Phone: $phone");
    ...
    print("ðŸŽ¯ UI State after update:");
  ...
  Widget build(BuildContext context) {
    if (_isCheckingPin) {
      return const Scaffold(backgroundColor: Colors.white, body: Center(child: CircularProgressIndicator(color: Color(0xFF248C70))));
    }
